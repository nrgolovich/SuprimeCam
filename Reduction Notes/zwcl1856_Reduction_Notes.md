...
These do not include the short exposures. Also the SUPE01539030 had terrible tracking errors

```
ln -s ../../rawdata/2015sep11/SUPA015390[4-9]?.fits .
```
...
1. Try running with a different astrometric reference catalog (e.g. SDSS-R5 instead of the default 2MASS)
	...
	```
	scamp object*cat -c scamp_scam.config -ASTREF_CATALOG USNO-B1
	```
