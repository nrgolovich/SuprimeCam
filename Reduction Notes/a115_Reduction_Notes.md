...
Range from SUPA00429660 to SUPA00429729

```
ln -s ../../rawdata/2005oct03/SUPA004296[6-9]?.fits .
ln -s ../../rawdata/2005oct03/SUPA004297[0-2]?.fits .
```
...
```
ln -s ../../flats/2005oct/$band'/skyflat'*.fits .
...
### Link to the raw data
Thesefile range from SUPA00243150 to SUPA00243269.


```
ln -s ../../rawdata/2003sep25/SUPA002431[5-9]?.fits .
ln -s ../../rawdata/2003sep25/SUPA002432[0-6]?.fits .
```
